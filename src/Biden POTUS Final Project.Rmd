...
資料取得與資料前處理：從`Twitter API`與`twitteR()`的`userTimeline()`函數載入推文擷取資料，並轉換成data frame，時間跨度涵蓋拜登`@POTUS`帳號截止至2021年6月13日共760筆，另有從`Kaggle`抓取`@JoeBiden`現成資料。之後將取得的的data frame整理出我們需要的變數。
...
load(file = "./data/biden_tweets_df.rda")
load(file = "./data/AllJoeBidenTweets.rda")
